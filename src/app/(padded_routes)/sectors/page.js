  ...
  return (
    <>
      <PageHero
        ...
        description="Amerind works across clean energy, EV charging, water quality, Tribal economic development, rural infrastructure, and AI-enabled funding workflows."
      />
      <section className="px-5 py-20 md:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="The sector mix reflects where Amerind can combine funding strategy with project structure, partner coordination, and implementation planning."
          />
